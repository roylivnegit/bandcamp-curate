...
- [ ] **"My genres" exclude-seed-tag dropdown.** *(proposed by the hourly routine, 2026-09-04,
  ...
  **Update:** already built in a parallel PR (#148) opened the same run — see the "My genres"
  entry higher up in this file for the real implementation notes; this stub is superseded, left
  here rather than edited out to avoid re-touching a file another open PR is also editing.
